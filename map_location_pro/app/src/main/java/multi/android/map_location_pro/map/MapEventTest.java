...
/*
    ...
    지도를 클릭하거나 지도를 드래그, 지도의 줌레벨 버튼을 이용해서 줌 레벨을 변경
    ...
    - OnCameraMoveListener: 지도의 위치가 바뀌거나 줌 레벨이 변경되어 카메라가 이동할 때 이벤트에 대할 처리
...
public class MapEventTest extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(map!=null){
            ...
            //현재 나의 위치를 포인트로 표시 - 위치 기반 서비스에 대한 퍼미션 체크가 완료되어야 표시됨.
